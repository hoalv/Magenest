...
namespace Magenest\OrderAttribute\Model\ResourceModel\Order\Attribute;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Attribute\Collection
{
    ...
    {
        $this->_init(
            'Magenest\OrderAttribute\Model\ResourceModel\Eav\Attribute',
    ...
    {
        return $this->getTable('magenest_orderattribute_order_eav_attribute');
    }
